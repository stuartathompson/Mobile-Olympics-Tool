...
?>
	<iframe id="header-iframe" src="http://www.theglobeandmail.com/sports/olympics/?service=wireframe&frag=top&link=iframe&showAds=true" width="1000px" height="322px" frameborder="0" scrolling="no" style="margin-left: -20px;margin-top: -20px;"></iframe>
...
?>
	<iframe id="footer-iframe" src="http://www.theglobeandmail.com/sports/olympics/?service=wireframe&frag=bottom&link=iframe&showAds=true" width="1000px" height="670px" frameborder="0" scrolling="no" style="margin-left: -20px;"></iframe>
<?php
}
